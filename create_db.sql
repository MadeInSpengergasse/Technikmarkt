...
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (3491259353835, 'Samsung',64, 699);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (5155067118967, 'Apple',128, 500);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (6311141528556, 'Samsung',256, 1120);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (1678229819502, 'Acer',1024, 670);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (9280930334340, 'ASUS',2048, 699);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (5524683880690, 'Lenovo',256, 699);
insert into p_produkt (p_gtin, p_a_anbietername,p_speicherkapazitaetgb,p_preis) values (5912725125416, 'chiliGreen',256, 699);
